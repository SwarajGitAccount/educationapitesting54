...
import com.education.payload.ErrorDetails;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleEducationAPIException(EducationAPIException ex,WebRequest webRequest){
